...
for epoch in range(200):
    ...
    f1score, recall, precision, meanBestF1, _ = utils.noCrossValidation(ind_dev.data, entropy_dev.data, label_list_dev, ind.data, entropy.data, label_list_test, none_ind)
